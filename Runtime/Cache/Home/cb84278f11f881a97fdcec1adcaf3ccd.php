...
<section>
	<ul class="tab-nav nav">
      <li class="current"><a href="javascript:;">修改密码<span class="arrow fa fa-sort-up"></span></a></li>
    </ul>
	<div class="span12 tab-content" style="margin:50px">
        <form class="login-form" action="/findyourhoney/index.php?s=/Home/User/profile.html" method="post">
          ...
          <div class="control-group">
            <div class="controls">
              <button type="submit" class="btn submit-btn">提 交</button>
            </div>
          </div>
        </form>
	</div>
