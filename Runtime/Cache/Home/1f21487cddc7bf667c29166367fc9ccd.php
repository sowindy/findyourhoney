...
<head>
	<meta charset="utf-8">
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Home/css/font-awesome.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Home/css/mobile_module.css?v=<?php echo SITE_VERSION;?>" media="all">
    <script type="text/javascript" src="/findyourhoney/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/findyourhoney/Public/Home/js/prefixfree.min.js"></script>
    <script type="text/javascript" src="/findyourhoney/Public/Home/js/m/dialog.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/findyourhoney/Public/Home/js/m/flipsnap.min.js"></script>
    <script type="text/javascript" src="/findyourhoney/Public/Home/js/m/mobile_module.js?v=<?php echo SITE_VERSION;?>"></script>
