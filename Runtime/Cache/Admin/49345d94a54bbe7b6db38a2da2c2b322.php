...
<head>
    ...
    <link href="/findyourhoney/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/base.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/common.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/module.css?v=<?php echo SITE_VERSION;?>" />
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/style.css?v=<?php echo SITE_VERSION;?>" media="all">
    <link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/store.css?v=<?php echo SITE_VERSION;?>" media="all">
	<link rel="stylesheet" type="text/css" href="/findyourhoney/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
     <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/findyourhoney/Public/Admin/js/jquery.mousewheel.js?v=<?php echo SITE_VERSION;?>"></script>
    <!--<![endif]-->
    
	<link rel="stylesheet" href="/findyourhoney/Public/Admin/js/codemirror/codemirror.css?v=<?php echo SITE_VERSION;?>" />
	<link rel="stylesheet" href="/findyourhoney/Public/Admin/js/codemirror/theme/<?php echo C('codemirror_theme');?>.css?v=<?php echo SITE_VERSION;?>" />
	<style>
		...
		#preview_window.loading{
			background: url('/findyourhoney/Public/static/thinkbox/skin/default/tips_loading.gif') no-repeat center;
		}
...
'model'=>'Example',		//要查的表
    ...
    <script type="text/javascript" src="/findyourhoney/Public/static/think.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript" src="/findyourhoney/Public/Admin/js/common.js?v=<?php echo SITE_VERSION;?>"></script>
    <script type="text/javascript">
        +function(){
	...
	<script type="text/javascript" src="/findyourhoney/Public/Admin/js/codemirror/codemirror.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/findyourhoney/Public/Admin/js/codemirror/xml.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/findyourhoney/Public/Admin/js/codemirror/javascript.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/findyourhoney/Public/Admin/js/codemirror/clike.js?v=<?php echo SITE_VERSION;?>"></script>
	<script type="text/javascript" src="/findyourhoney/Public/Admin/js/codemirror/php.js?v=<?php echo SITE_VERSION;?>"></script>

	<script type="text/javascript" src="/findyourhoney/Public/static/thinkbox/jquery.thinkbox.js?v=<?php echo SITE_VERSION;?>"></script>
